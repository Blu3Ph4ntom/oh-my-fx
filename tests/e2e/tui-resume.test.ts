...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    ...
    try {
      ...
      const updatedNotice = `● omfx has been updated to v${version}`;
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    ...
    try {
      ...
      await active.waitForText(`● omfx has been updated to v${version}`, TIMEOUT);
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    ...
    try {
      ...
      expect(currentPicker).not.toContain("omfx");
