...
pub const yolo_warning_text = "Full access enabled: omfx permission checks and sandboxing disabled";
...
/// Human-readable name; the persisted and wire value remains `yolo` for
/// backwards-compatible settings and session data.
